...
public class MultipleLinearRegression {
    ...
    private void betas() {
        ...
        beta_0 = (((sigmaY * sigmaXsqr1 * sigmaXsqr2) + (sigmaX1 * sigmaX12 * sigmaX2Y)
                + (sigmaX2 * sigmaX1Y * sigmaX12) - (sigmaX2Y * sigmaXsqr1 * sigmaX2) - (sigmaX12 * sigmaX12 * sigmaY)
                - (sigmaXsqr2 * sigmaX1Y * sigmaX1)) / d);
        beta_1 = (((sigmaX1Y * sigmaXsqr1 * sigmaXsqr2) + (sigmaX1 * sigmaX12 * sigmaX2Y)
                + (sigmaX2 * sigmaX1Y * sigmaX12) - (sigmaX2Y * sigmaXsqr1 * sigmaX2) - (sigmaX12 * sigmaX12 * sigmaX1Y)
                - (sigmaXsqr2 * sigmaX1Y * sigmaX1)) / d);
        beta_2 = (((sigmaX2Y * sigmaXsqr1 * sigmaXsqr2) + (sigmaX1 * sigmaX12 * sigmaX2Y)
                + (sigmaX2 * sigmaX1Y * sigmaX12) - (sigmaX2Y * sigmaXsqr1 * sigmaX2) - (sigmaX12 * sigmaX12 * sigmaX2Y)
                - (sigmaXsqr2 * sigmaX1Y * sigmaX1)) / d);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mlr.equationMLR());
    }
}